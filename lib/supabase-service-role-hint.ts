...
export const SUPABASE_SERVICE_ROLE_MISSING =
  'Nedostaje SUPABASE_SERVICE_ROLE_SECRET na serveru (npr. Vercel → Settings → Environment Variables). ' +
  'U Supabase: Project Settings → API → tajni „service_role“ ključ. Dodaj kao SUPABASE_SERVICE_ROLE_SECRET, pa Redeploy. ' +
